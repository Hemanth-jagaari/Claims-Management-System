...
export class SelectDetailService {
  public hospitalDetails: Array<HospitalDetail> = [
   ...
   public policyDetails: Array<PoilcyDetail> = [
    { id: 'P1001', name: 'Health Plus Classic' ,sumInsured:500000,Premium:15639},
    { id: 'P1002', name: 'Health Plus Enhanced',sumInsured:3000000,Premium:17361},
    { id: 'P1003', name: 'Health Plus Premium',sumInsured:10000000,Premium:22085},
  ];
